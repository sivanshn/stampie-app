/**
 * Öffentliche Seiten, die vor der App-Store-Abgabe live geschaltet werden müssen.
 *
 * Diese URLs stehen absichtlich zentral, damit App Store Connect, die App und die
